...
variable "rancher_password" {
  description = "password for rancher server admin user"
  type        = string
  sensitive   = true
}
...
# RDS k3s datastore variables
#variable "db_password" {
#  description = "password for rancher k3s admin db user"
#  type        = string
#  sensitive   = true
#}
#variable "db_name" {
#  description = "DB name used in RDS instance "
#  type        = string
#}
